...
console.log("Based on the information provided" + "," + " " + "The total amount spend on expenses and entretainment is" + " " + totalExpensesAndEntert);//store the total from variable totalExpensesAndEntert//
console.log("we determine that you should save 30% of the amount left after calculating your expenses and entertainment spendings. Therefore, your total saving amount is" + totalSavings);//This is the final output to display the total amount the user should put aside for savings based on the total amount after substracting commute, expenses, entertainment spending and multiplying by .30 which is 30% of that amount//